...
Statistics:
	...
	- {top_eip_2}: {top_eip_2_num}
            ...
            # Sender Gmail Sign In
            gmail_sender = self.config_private['email']['shettypramith246@gmail.com']
            gmail_passwd = self.config_private['email']['Leaddataengineer@123']
    ...
    def run(self):
        ssc = StreamingContext.getOrCreate(os.environ['VISORHOME'] + '/src/kafka_monitor/checkpoint/',
